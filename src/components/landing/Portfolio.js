...
import { GoMarkGithub, GoPlug } from "react-icons/go";

function Portfolio() {
  return (
    <Fragment>
      <div className="col-12 pb-5 mb-5 head-title">
        <h1 style={{ marginTop: null }}>PORTFOLIO</h1>
        <h4 className="text-primary">{`{/* latest projects */}`}</h4>
      </div>
      <div className="col-sm-12 col-md-4">
        <div className="card mb-4 bg-light pt-2" style={{ background: null }}>
          <img className="card-img-top" alt="project thumbnail" src={enmIntl} />
      ...
      <div className="col-sm-12 col-md-4">
        <div className="card mb-4 bg-light pt-2" style={{ background: null }}>
          <img className="card-img-top" alt="project thumbnail" src={enmRu} />
          <div className="card-body">
      ...
      <div className="col-sm-12 col-md-4">
        <div className="card mb-4 bg-light pt-2" style={{ background: null }}>
          <img className="card-img-top" alt="project thumbnail" src={mobile} />
          <div className="card-body">
            <h5 className="card-title text-center">
      ...
      <div className="col-sm-12 col-md-4">
        <div className="card mb-4 bg-light pt-2" style={{ background: null }}>
          <img className="card-img-top" alt="project thumbnail" src={jobs} />
          <div className="card-body">
      ...
      <div className="col-sm-12 col-md-4">
        <div className="card mb-4 bg-light pt-2" style={{ background: null }}>
          ...
          />
          <div className="card-body">
            <h5 className="card-title text-center">Products Info</h5>
            <p className="card-text text-primary">
              React/Redux/Node/Express/MySql
            </p>
            <div style={{ display: "flex", justifyContent: "space-around" }}>
      ...
      <div className="col-sm-12 col-md-4">
        <div className="card mb-4 bg-light pt-2" style={{ background: null }}>
          <img className="card-img-top" alt="project thumbnail" src={enmRu} />
          <div className="card-body">
            <h5 className="card-title text-center">Email Newsletter</h5>
            <p className="card-text text-primary">
